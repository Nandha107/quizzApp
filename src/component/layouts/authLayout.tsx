...
export const AuthLayout: React.FC<AuthLayout> = ({}) => {
	...
	return (
		<div className="h-screen flex flex-col border-2 border-red-900">
			<div className="px-2 md:px-5 shadow-lg bg-white z-[1000]">
				<Header />
			</div>
			<div className="h-full transition-all duration-700 bg-slate-600/5">
				<Suspense
					fallback={<LoadingSpinner text="Please wait while loading goodies..." />}
				>
					<Outlet />
				</Suspense>
			</div>
...
// 			<div className="h-[7%] w-full px-2 md:px-5 shadow-lg bg-white z-[1000]">
// 				<Header />
// 			</div>
